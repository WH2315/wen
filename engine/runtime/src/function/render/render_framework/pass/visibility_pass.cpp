...
void VisibilityPass::createRenderResource(std::shared_ptr<Renderer::Renderer> renderer, Resource& resource) {
    ...
    visibility_pipeline_pipeline_->setVertexInput(interface->createVertexInput({
        ...
        {1, Renderer::InputRate::eInstance, {Renderer::VertexType::eFloat4, Renderer::VertexType::eFloat4, Renderer::VertexType::eFloat4, Renderer::VertexType::eFloat4, Renderer::VertexType::eFloat4, Renderer::VertexType::eFloat4, Renderer::VertexType::eFloat4, Renderer::VertexType::eFloat4, Renderer::VertexType::eFloat4}}
    }));
